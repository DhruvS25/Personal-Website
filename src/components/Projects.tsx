  ...
  return (
    <section id="projects" className="min-h-screen flex items-center justify-center px-4 py-12 sm:py-16 md:py-20">
      <div className="mx-auto max-w-4xl w-full">
        ...
        >
          <h2 className="font-oxanium font-bold text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-lightprimary dark:text-darkprimary">Projects</h2>
        ...
        >
          <h3 className="font-oxanium font-bold text-xl sm:text-2xl md:text-3xl font-bold mb-4 sm:mb-6 text-lightsecondary dark:text-darksecondary">
            Personal Projects
          </h3>
